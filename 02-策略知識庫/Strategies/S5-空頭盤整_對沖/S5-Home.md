...
inputs: 
outputs: s5_positions.csv; s5_hedge_log.csv
update: 依版本
...
## 🟩 最新版本摘要（Auto）
```dataviewjs
const pages = dv.pages("01-Modules/Strategies/S5-空頭盤整_對沖/Versions")
...
FROM "01-Modules/Strategies/S5-空頭盤整_對沖/Versions"
SORT version_seq DESC
```

## 📚 知識筆記
```dataview
LIST FROM "01-Modules/Strategies/S5-空頭盤整_對沖/Knowledge"
SORT file.name ASC
```
...
FROM "01-Modules/Strategies/S5-空頭盤整_對沖/Decisions"
SORT date DESC
```
