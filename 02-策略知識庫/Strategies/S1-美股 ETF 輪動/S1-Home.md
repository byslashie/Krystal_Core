...
const VERSION_FOLDER = '01-Modules/Strategies/S1-美股 ETF 輪動/Versions';
...
## 🔬 回測（Backtests）
```dataview
TABLE file.link as "Backtest", version, run_date, cagr_pct, sharpe,mdd_pct , calmar,trades,avg_profit_pct,avg_loss_pct,ev_pct,kelly_full
